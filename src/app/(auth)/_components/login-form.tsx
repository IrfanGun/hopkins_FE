  ...
  return (
    <form onSubmit={handleSubmit} className="w-full">
      ...
      <div className="mt-6">
        <button
          type="button"
          className="w-full rounded-lg border border-gray-300 bg-white px-5 py-4 font-semibold text-gray-700 shadow-sm transition-all duration-300 hover:bg-gray-50 hover:shadow-md"
        >
          Sign in with other
        </button>
      </div>
