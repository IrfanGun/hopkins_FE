...
export default function AffiliatePage() {
        ...
        try {
          setIsLoading(true);
           const response = await fetchPartner();
            ...
            const popularPartners = response.filter((partner) => partner.isPopular);

          setPartners(popularPartners);
        } catch (error) {
  ...
  const handleFilterChange = (filtered: Partner[]) => {
    const filterPopular = filtered.filter((partner) => partner.isPopular);
    setFilteredPartners(filterPopular);
  };
      ...
      <div className="flex-grow">
        ...
        <div className="container mx-auto mt-4 px-4 lg:mt-8 lg:px-6">
          <div className="flex flex-col lg:flex-row lg:space-x-8">
            ...
            >
              <FilterPartners onFilterChange={handleFilterChange} isPopularFilter={true}/>
            </div>
              ...
              <div className="mb-4 flex flex-col space-y-3 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                ...
                <div className="flex w-full items-center sm:w-auto">
                  <input
                    ...
                    className="w-full rounded border border-gray-300 p-2 sm:w-auto focus:ring-2 focus:ring-orange-600 focus:outline-none transition duration-200"
                  />
                </div>
              </div>
