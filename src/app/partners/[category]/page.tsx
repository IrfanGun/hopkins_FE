    ...
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex-grow">
        ...
        paginatedPartners.map((partner, index) => (
          <div key={`${partner.id}-${index}`} className="flex flex-col rounded bg-white p-4 shadow-md sm:flex-row sm:items-center">
            {/* Partner Logo */}
            <div className="mb-4 flex justify-center sm:mb-0 sm:mr-4 sm:justify-start">
              <img src={partner.logo || "/placeholder.svg"} alt={partner.name} className="h-16 w-20 sm:h-20 sm:w-28" />
            </div>
            ...
            <div className="flex flex-col items-center sm:items-end">
              <button className="w-full rounded-full bg-orange-500 px-4 py-2 text-white transition hover:bg-orange-600 sm:w-auto sm:min-w-[120px]" onClick={() => openModal(partner)}>
                Get Code
              </button>
            </div>
          </div>
